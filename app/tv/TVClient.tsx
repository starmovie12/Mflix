...
export default function TVClient({ rows, genres }: TVClientProps) {
  return (
    <PageShell>
      <main className="min-h-screen pt-20">
        <div className="px-4 pb-4 md:px-12">
          <h1 className="text-fluid-3xl font-bold">TV Shows</h1>
          <p className="mt-1 text-sm text-zinc-400">
            Discover popular series, new episodes, and critically acclaimed shows.
          </p>
          {genres.length > 0 && (
